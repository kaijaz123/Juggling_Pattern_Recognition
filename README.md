...
# Instructions 
1. Please stand in a reasonable distance to laptop camera (or any other external connected camera), recommended 1-1.2 meters. The estimated distance is displayed in the data dashboard in output video.
