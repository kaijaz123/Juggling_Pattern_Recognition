...
2. Currently supports only up to 3 balls juggling.
3. Currently supports only basic form of juggling siteswap pattern, variant of patterns are not supported.
4. Please prevent same colors between clothes, balls, and background (also light background).
